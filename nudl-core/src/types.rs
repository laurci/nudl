...
impl TypeInterner {
    ...
    // Well-known type IDs
    pub fn i32(&self) -> TypeId { TypeId(0) }
    pub fn i64(&self) -> TypeId { TypeId(1) }
    pub fn u64(&self) -> TypeId { TypeId(2) }
    pub fn bool(&self) -> TypeId { TypeId(3) }
    pub fn unit(&self) -> TypeId { TypeId(4) }
    pub fn string(&self) -> TypeId { TypeId(5) }
    pub fn raw_ptr(&self) -> TypeId { TypeId(6) }
    pub fn error(&self) -> TypeId { TypeId(7) }
}
...
mod tests {
    ...
    fn pre_interned_types() {
        ...
        assert_eq!(*ti.resolve(ti.i32()), TypeKind::Primitive(PrimitiveType::I32));
        assert_eq!(*ti.resolve(ti.unit()), TypeKind::Primitive(PrimitiveType::Unit));
